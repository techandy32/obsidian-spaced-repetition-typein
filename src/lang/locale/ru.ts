...
export default {
    ...
    CORRECT: "Correct!",
    INCORRECT: "Incorrect",
    INLINE_TYPEIN_CARDS_SEPARATOR: "Separator for inline type-in flashcards",
    MULTILINE_TYPEIN_CARDS_SEPARATOR: "Separator for multiline type-in flashcards",
    TYPEIN_CASE_SENSITIVE: "Type-in answer case sensitive",
    TYPEIN_CASE_SENSITIVE_DESC:
        "If enabled, typed answers must match the exact case of the correct answer",
